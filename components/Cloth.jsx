...
import ClothesPage from '../Product/Clothes/ClothesPage';
...
const Cloth = () => {
    ...
    useEffect(()=>{
        ...
        axios.get("http://localhost:8080/Cloth").then((response)=>{
       ...
       <div class="product_result_ks">
        <div class="sidebar_ks">
            ...
            <div class="shop_by_ks">
                <h3>SHOP BY</h3>
                <div class="zoom">NEW ARRIVAL</div>
                <div class="zoom">COLOR</div>
                <div class="zoom">PRICE</div>
                <div class="zoom">BRAND</div>
                <div class="zoom">THEME</div>
                <div class="zoom">MATERIAL</div>
            </div>
        ...
        <div>
            ...
            <div className="select_sort"><select onChange={handleSort}>
                                <option value="">Sort:Position</option>
            ...
            {clothes.map((e)=>{
              return( <div className='product_map'>
                ...
                <div className='price'>
                    ...
                    <div style={{color:"teal"}}>₹{e.newprice}</div>
