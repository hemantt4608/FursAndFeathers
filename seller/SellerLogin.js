...
const SellerLogin = () => {
  ...
  return (
    <div>
      <div className="loginheader_at"><h2><b>Seller Login</b></h2></div>
      <div className="container">
        <div className="loginsection_at">
            ...
            <div className="logandregiter_at" >
                 ...
                 <div className="login_heading_at">REGISTERED SELLERS</div>
                ...
                <div  className="logandregiter_at">
                    <div className="login_heading_at">NEW SELLER</div>
                   ...
                   <Link to="/SellerRegister"><button className="login_button_at" onclick="gotoregister()">CREATE AN ACCOUNT</button></Link> 
                </div>
         </div>    
    </div>
    </div>
